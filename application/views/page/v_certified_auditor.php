    ...
    <div class="container">
      <div class="row margin-top-10px">
        <div class="col-lg-12 mx-auto">
          ...
          <h4 class="pb-5"><span class="la la-search input-icon"></span> ค้นหาข้อมูลรายชื่อผู้ตรวจประเมิน</h4>
            ...
            <div class="card-box-shared">
                <div class="card-box-shared-body">
                    <div class="contact-form-action">
                        <form method="get" id="frm-auditor-search">
                            <input type="hidden" id="type" name="type" value="auditor"/>
                            <div class="row">

                                <div class="col-lg-3">
                                    <div class="input-box">
                                        <label class="label-text">ชื่อผู้ตรวจประเมิน<span class="primary-color-2 ml-1">*</span></label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="auditor_name" id="auditor_name" placeholder="ระบุ ชื่อผู้ตรวจประเมิน" value="">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="auditor_company" id="auditor_company" placeholder="ระบุ ชื่อหน่วยงาน" value="">
                                            <span class="la la-search input-icon"></span>
                                        </div>
                                    </div>
                                </div>
                                          ...
                                          <div class="form-group">
                                            <div class="form-check-inline">
                                              <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="specializes-economies" name="auditor_specializes" value="economies" >
                                                <label class="custom-control-label" for="specializes-economies">ด้านเศรษฐนิเวศ</label>
                                              </div>
                                            </div>
                                            <div class="form-check-inline my-2">
                                              <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="specializes-environmental" name="auditor_specializes" value="environmental" >
                                                <label class="custom-control-label" for="specializes-environmental">ด้านสิ่งแวดล้อม</label>
                                              </div>
                                            </div>
                                            <div class="form-check-inline my-2">
                                              <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="specializes-csr" name="auditor_specializes" value="csr">
                                ...
                                <div class="col-lg-12 text-left">
                                  <div class="btn-box">
                                      <button class="theme-btn" type="button" onclick="searchAuditor();"><span class="la la-search input-icon"></span> ค้นหา</button>
                                      <button class="btn btn-default" type="button" onclick="page('page/view/certified_auditor');"> เคลียร์ข้อมูล</button>
                                  </div>
                                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="d-flex flex-column flex-md-row mb-3 mb-md-0">
                <nav class="mr-auto d-flex align-items-center" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="active breadcrumb-item" aria-current="page" id="page-result-title">รายชื่อผู้ตรวจประเมิน</li>
                    </ol>
                </nav>
                <div role="toolbar" class="btn-toolbar">
                  <div role="group" class="btn-group pr-2">
                    <button id="tooltipAddNew" class="align-self-center btn btn-success" onclick="exportExcel('data-table','รายชื่อผู้ตรวจประเมิน')"><i class="mdi mdi-file-excel"></i> Download (Excel)</button>
                  </div>
                </div>
            </div>
            <div class="mb-3 Card_custom-card--border_5wJKy card">
                <div class="table-responsive-xl">
                    ...
                    <table class="mb-0 table table-hover" id="data-table">
                        ...
                        <?php
                          ...
                          $order = $data["auditor"]["Paging"]['order'];
                          foreach ($data["auditor"]['table'] as $auditor)
                          {
                            $order++;
                            ...
                            <tr>
                              ...
                              <td class='align-middle' width='30%'>
                                <div><strong>{$auditor['contact_firstname']} {$auditor['contact_lastname']}</strong></div><span>{$auditor['contact_phone']} <br>{$auditor['contact_email']}</span>
                              </td>
                              <td class='align-middle' width='30%'>
                ...
                <?php echo $data["auditor"]["Paging"]['display'];?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <div class="btn-box text-right">
                    <a href="app/create/uWBrd6z7IPcJHAccFttegk2cHDGONG" class="theme-btn">ลงทะเบียนผู้ตรวจประเมิน</a>
                </div><!-- end btn-box-->
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
    </div><!-- end container -->

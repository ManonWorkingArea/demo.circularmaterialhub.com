        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="my-courses-tab">
                    ...
                    <input id="tab-2" type="radio" name="radio-set" class="tab-selector-2" checked="checked" onchange="page('app/view_upload/<?php echo $data['Application']['ap_token']?>')"/>

              ...
              <div class="col-md-12">
                <div class="container-fluid">
                  <ul class="list-unstyled multi-steps">
                    ...
                    <li onclick="page('app/assumption/specific/7');" class="is-active">ข้อที่ 7</li>
              ...
              <div class="col-md-12">
                <table class="table table-striped table-bordered text-left">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th>7. การจัดการสารเคมีและวัตถุอันตราย (5 คะแนน) </br><span class="description">ผู้ประกอบอุตสาหกรรม ต้องดำเนินการการจัดการสารเคมีและวัตถุอันตรายอย่างมีประสิทธิภาพ ตามข้อกำหนดดังนี้</span><span class="pull-right score-result">ผลลัพธ์ 0 คะแนน</span></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">จัดทำบัญชีรายการสารเคมีและวัตถุอันตราย ปริมาณครอบครอง รายละเอียดข้อมูลความปลอดภัย</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">มีระบบการจัดการสารเคมีและวัตถุอันตราย เพื่อป้องกันการเกิดอุบัติเหตุรั่วไหล อัคคีภัย อุบัติภัย ตามคู่มือการเก็บรักษาสารเคมีและวัตถุอันตรายของ กรมโรงงานอุตสาหกรรม หรือ อื่นๆ ที่เทียบเท่า</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">มีการประเมินความเสี่ยงของสารเคมีและวัตถุอันตราย</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">มีนโยบายและดำเนินการใช้สารทดแทนหรือสารที่เป็นอันตรายน้อยกว่า</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">ไม่มีการเกิดอุบัติเหตุรั่วไหล อัคคีภัย และอุบัติภัย จากสารเคมี และ/หรือวัตถุอันตราย</div>
                      </td>
                ...
                <div class="col-lg-12">
                    <div class="btn-box  pull-left">
                        <a href="javascript:void(0);" class="btn btn-success btn-lg" onclick="nextPage('8');"><i class="fa fa-step-forward"></i> ข้อต่อไป</a>
                    </div>
                </div>
              </div>
            </div>

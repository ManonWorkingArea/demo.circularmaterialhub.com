    ...
    <div class="course-wrapper">
        <div class="container text-center">
            ...
            <div class="row">
                           ...
                           $url       = "form/multiple/" . $app_id . "/" . $set_id . "/" . $set_token . "/" . $member_id . "/" . $data["choice"];
                        ...
                        <?php //print_r($output['choice']);?>
                        

              <div class="col-md-12">
                <div class="top-head">
                  <div class="text">ข้อกำหนดเฉพาะของมาตรฐานโรงงานอุตสาหกรรมเชิงนิเวศ (Specific requirements for Eco factory) <div class="back-home" onclick="page('app/assumption/dashboard/<?php echo $ap_token;?>/standard_specification');"><i class="fa fa-home"></i> กลับหน้าหลัก</div>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="container-fluid">
                  <ul class="list-unstyled multi-steps">
                    ...
                    <li onclick="page('app/assumption/specific/2');" class="is-active">ข้อที่ 2</li>
              ...
              <div class="col-md-12">
                <table class="table table-striped table-bordered text-left">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th>2. การจัดการการพลังงาน (5 คะแนน) </br><span class="description">ผู้ประกอบอุตสาหกรรมต้องดำเนินการการจัดการพลังงานอย่างมีประสิทธิภาพตามข้อกำหนดดังนี้</span><span class="pull-right score-result">ผลลัพธ์ 0 คะแนน</span></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">จัดทำบัญชีรายการและปริมาณการใช้พลังงาน แยกตามประเภทพลังงาน</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">กำหนดวัตถุประสงค์ ระบุเป้าหมายขององค์กร จัดทำแผนการดำเนินงาน และ ดำเนินมาตรการเพิ่มประสิทธิภาพการใช้พลังงาน โดยมีผลการดำเนินงานบรรลุตามค่าเป้าหมายที่องค์กรกำหนด
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">
                          ...
                          ดำเนินการจัดการพลังงานอย่างมีประสิทธิภาพตามมาตรการอย่างใดอย่างหนึ่ง ดังนี้</br>

                          <div class="inline-form">
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_1" value="1">
                                  <label for="topic_3_score_1"><span class="line-height-24 d-block"></span>ประเมินค่าประสิทธิภาพการใช้พลังงาน (Energy intensity) โดยมีค่าประสิทธิภาพดีขึ้นต่อเนื่องทุกปี อ้างอิงข้อมูล 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_2" value="2">
                                  <label for="topic_3_score_2"><span class="line-height-24 d-block"></span>นำพลังงานเหลือทิ้งจากสถานประกอบการหรือภาคส่วนอื่นๆ มาใช้เป็นพลังงาน (Symbiosis) ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_3" value="3">
                                  <label for="topic_3_score_3"><span class="line-height-24 d-block"></span>ประเมินค่าเปรียบเทียบเชิงสมรรถนะ (Performance Benchmarking) การจัดการพลังงาน โดยมีค่าเปรียบเทียบเชิงสมรรถนะสูงกว่าค่าเฉลี่ยของกลุ่มอุตสาหกรรมเดียวกัน ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  ...
                                  <label for="topic_3_score_4"><span class="line-height-24 d-block"></span>ได้รับรางวัลด้านการจัดการพลังงานระดับองค์กร ที่เป็นที่ยอมรับระดับชาติ ภูมิภาค หรือ สากล ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  ...
                                  <label for="topic_3_score_5"><span class="line-height-24 d-block"></span>ได้รับการรับรองระบบการจัดการพลังงาน (ISO 50001) ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                          </div>
                ...
                <div class="col-lg-12">
                    <div class="btn-box  pull-left">
                        <a href="javascript:void(0);" class="btn btn-success btn-lg" onclick="nextPage('3');"><i class="fa fa-step-forward"></i> ข้อต่อไป</a>
                    </div>
                </div>
              </div>
...
$(document).ready(function()
{
  //----------------------------------------------------------------------------
  // TOPIC 1
  var quiz2_topic_1 = localStorage.getItem("quiz2_topic_1");
  if (quiz2_topic_1 !== null)
  {
    if(quiz2_topic_1==="checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 2
  var quiz2_topic_2 = localStorage.getItem("quiz2_topic_2");
  if (quiz2_topic_2 !== null)
  {
    if(quiz2_topic_2 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE
  var quiz2_topic_2_score = localStorage.getItem("quiz2_topic_2_score");
  if (quiz2_topic_2_score !== null)
  {
    $('input:radio[name=topic_2_score][value='+quiz2_topic_2_score+']').attr('checked', true);
  }
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE TEXT
  var quiz2_topic_2_score_text = localStorage.getItem("quiz2_topic_2_score_text");
  if (quiz2_topic_2_score_text !== null)
  {
    $('#topic_2_score_text').val(quiz2_topic_2_score_text);
  }
  //----------------------------------------------------------------------------
  // TOPIC 3
  var quiz2_topic_3 = localStorage.getItem("quiz2_topic_3");
  if (quiz2_topic_3 !== null)
  {
    if(quiz2_topic_3 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 1
  var quiz2_topic_3_score_1 = localStorage.getItem("quiz2_topic_3_score_1");
  if (quiz2_topic_3_score_1 !== null)
  {
    if(quiz2_topic_3_score_1 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 2
  var quiz2_topic_3_score_2 = localStorage.getItem("quiz2_topic_3_score_2");
  if (quiz2_topic_3_score_2 !== null)
  {
    if(quiz2_topic_3_score_2 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 3
  var quiz2_topic_3_score_3 = localStorage.getItem("quiz2_topic_3_score_3");
  if (quiz2_topic_3_score_3 !== null)
  {
    if(quiz2_topic_3_score_3 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 4
  var quiz2_topic_3_score_4 = localStorage.getItem("quiz2_topic_3_score_4");
  if (quiz2_topic_3_score_4 !== null)
  {
    if(quiz2_topic_3_score_4 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 5
  var quiz2_topic_3_score_5 = localStorage.getItem("quiz2_topic_3_score_5");
  if (quiz2_topic_3_score_5 !== null)
  {
    if(quiz2_topic_3_score_5 === "checked")
    {
...
function recapStepCheck(ids)
{
  ...
  if(count>=recapGroups_count)
  {
    ...
    localStorage.setItem("quiz2_topic_" + ids, "checked");
    localStorage.setItem("quiz2_topic_" + ids + "_score", radioanswer);
  }
  else
  {
    $("#topic_" + ids).attr("checked", false);
    localStorage.setItem("quiz2_topic_" + ids, "unchecked");
    localStorage.setItem("quiz2_topic_" + ids + "_score", "0");
  }
  return radioanswer;
}
...
window.onbeforeunload = function()
{
  ...
  {
    localStorage.setItem("quiz2_topic_1", "checked");
  }
  else
  {
    localStorage.setItem("quiz2_topic_1", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE
  localStorage.setItem("quiz2_topic_2_score_text", $('#topic_2_score_text').val());

  //----------------------------------------------------------------------------
  // TOPIC 3 - 1
  if($('#topic_3_score_1').is(':checked'))
  {
    localStorage.setItem("quiz2_topic_3_score_1", "checked");
  }
  else
  {
    localStorage.setItem("quiz2_topic_3_score_1", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 2
  if($('#topic_3_score_2').is(':checked'))
  {
    localStorage.setItem("quiz2_topic_3_score_2", "checked");
  }
  else
  {
    localStorage.setItem("quiz2_topic_3_score_2", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 3
  if($('#topic_3_score_3').is(':checked'))
  {
    localStorage.setItem("quiz2_topic_3_score_3", "checked");
  }
  else
  {
    localStorage.setItem("quiz2_topic_3_score_3", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 4
  if($('#topic_3_score_4').is(':checked'))
  {
    localStorage.setItem("quiz2_topic_3_score_4", "checked");
  }
  else
  {
    localStorage.setItem("quiz2_topic_3_score_4", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 5
  if($('#topic_3_score_5').is(':checked'))
  {
    localStorage.setItem("quiz2_topic_3_score_5", "checked");
  }
  else
  {
    localStorage.setItem("quiz2_topic_3_score_5", "unchecked");
  }
  //----------------------------------------------------------------------------
}

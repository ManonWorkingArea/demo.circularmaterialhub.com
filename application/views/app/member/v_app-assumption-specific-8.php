              ...
              <div class="col-md-12">
                <div class="container-fluid">
                  <ul class="list-unstyled multi-steps">
                    ...
                    <li onclick="page('app/assumption/specific/8');" class="is-active">ข้อที่ 8</li>
                ...
                <table class="table table-striped table-bordered text-left">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th>8. การจัดการสุขภาพและความปลอดภัยในการทำงาน (5 คะแนน) </br><span class="description">ผู้ประกอบอุตสาหกรรม ต้องดำเนินการการจัดการอาชีวอนามัยและความปลอดภัย ตามข้อกำหนดดังนี้</span><span class="pull-right score-result">ผลลัพธ์ 0 คะแนน</span></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">มีการประเมินความเสี่ยงด้านอาชีวอนามัยและความปลอดภัย และไม่เกิดอุบัติเหตุร้ายแรงถึงขั้นเสียชีวิตหรือทุพพลภาพในปีล่าสุด</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">กำหนดวัตถุประสงค์ เป้าหมายการควบคุมอุบัติเหตุในการทำงาน จัดทำแผนการดำเนินงานด้านการจัดการอาชีวอนามัยและความปลอดภัย</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">กำหนดวัตถุประสงค์ เป้าหมายการควบคุมอุบัติเหตุในการทำงาน จัดทำแผนการดำเนินงานด้านการจัดการอาชีวอนามัยและความปลอดภัย  โดยมีผลการดำเนินงานบรรลุตามค่าเป้าหมายที่องค์กรกำหนด  หรือได้รับการรับรองตามมาตรฐานระบบการจัดการด้านอาชีวอนามัยและความปลอดภัย ภายในระยะเวลา 3 ปี ย้อนหลัง</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">ไม่เกิดอุบัติเหตุร้ายแรงที่กระทบกับภายนอกองค์กร และ ไม่เกิดอุบัติเหตุถึงขั้นหยุดงาน (DAWC) ในปีล่าสุด หรือ อัตราความถี่ของการเกิดประสบอันตราย (Injury Frequency Rate ; IFR) ที่ 200,000 ชั่วโมง มีอัตราลดลงในปีล่าสุด
</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">
                          ...
                          ดำเนินการจัดการอาชีวอนามัยและความปลอดภัยอย่างมีประสิทธิภาพอย่างใดอย่างหนึ่ง ดังนี้ </br>

                          <div class="inline-form">
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_5_score" id="topic_5_score_1">
                                  <label for="topic_5_score_1"><span class="line-height-24 d-block"></span>ไม่เกิดอุบัติเหตุถึงขั้นหยุดงาน (DAWC) ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_5_score" id="topic_5_score_2">
                                  <label for="topic_5_score_2"><span class="line-height-24 d-block"></span>อัตราความถี่ของการเกิดประสบอันตราย (Injury Frequency Rate ; IFR ที่ 200,000 ชั่วโมง) มีอัตราลดลงต่อเนื่อง อ้างอิงข้อมูล 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_5_score" id="topic_5_score_3">
                                  <label for="topic_5_score_3"><span class="line-height-24 d-block"></span>ได้รับรางวัลสถานประกอบการดีเด่นด้านการจัดการอาชีวอนามัยและความปลอดภัย ระดับจังหวัด ระดับชาติ ระดับภูมิภาค หรือ ระดับสากล ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                  ...
                  <div class="col-lg-12">
                      <div class="btn-box  pull-left">
                          <a href="javascript:void(0);" class="btn btn-success btn-lg" onclick="nextPage('9');"><i class="fa fa-step-forward"></i> ข้อต่อไป</a>
                      </div>
                  </div>
              </div>

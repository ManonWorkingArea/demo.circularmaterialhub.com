                                          ...
                                          <div class="breadcrumb-content dashboard-bread-content align-items-center justify-content-between row">
                                              ...
                                              <div class="application-action-tools col-md-6">
                                                  ...
                                                  <div class="error">
                                                    ...
                                                    <span class="form-percent font-30 text-muted"><i class="mdi mdi-square-edit-outline font-30 text-dark"></i> <?php echo $data["formAPI"]['fillPercent']?>%</span>
                                                    <span class="float-right text-right text-muted" style="line-height: 14px;"><small class="text-dark">แบบฟอร์ม</small><br><strong><?php echo $data["formAPI"]['fillMessage']?></strong></span>
                                                    </div>

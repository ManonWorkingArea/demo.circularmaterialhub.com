            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <table class="table table-bordered text-left">
                  <thead class="thead-dark">
                    <tr>
                      <th width="5"><i class="fa fa-file"></i></th>
                      <th>ข้อเสนอแนะจากผู้ตรวจประเมิน</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="top-form-head">
                ...
                <table class="table table-bordered text-left reply-table">
                  <thead class="thead-dark">
                    <tr>
                      <th width="5"><i class="fa fa-file"></i></th>
                      <th>คำชี้แจงจากสถานประกอบการ</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="top-form-head">
              ...
              <div class="col-lg-12">
                  <div class="btn-box">
                      ...
                      <a href="javascript:void(0);" class="btn btn-default btn-lg" onclick="nextPage('2');"><i class="fa fa-step-forward"></i> ข้อถัดไป</a>
                  </div>
              </div>
              </div>
            </div>

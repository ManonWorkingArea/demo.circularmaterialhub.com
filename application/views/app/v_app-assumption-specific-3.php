              ...
              <div class="col-md-12">
                <div class="container-fluid">
                  <ul class="list-unstyled multi-steps">
                    ...
                    <li onclick="page('app/assumption/specific/3');" class="is-active">ข้อที่ 3</li>
              ...
              <div class="col-md-12">
                <table class="table table-striped table-bordered text-left">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th>3. การจัดการน้ำและน้ำเสีย (5 คะแนน) </br><span class="description">ผู้ประกอบอุตสาหกรรมต้องดำเนินการการจัดการน้ำและน้ำเสียอย่างมีประสิทธิภาพตามข้อกำหนดดังนี้</span><span class="pull-right score-result">ผลลัพธ์ 0 คะแนน</span></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">จัดทำบัญชีรายการและปริมาณการใช้น้ำและปริมาณน้ำเสีย รวมทั้ง สมดุลน้ำ (Water balance) ระบุกิจกรรมที่ใช้น้ำกับปริมาณน้ำเสียที่เกิดขึ้นในแต่ละกระบวนการผลิตและกิจกรรมสนับสนุนอื่นๆ ขององค์กร   </div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">กำหนดวัตถุประสงค์ ระบุเป้าหมายขององค์กร จัดทำแผนการดำเนินงาน และ ดำเนินมาตรการเพิ่มประสิทธิภาพการจัดการน้ำและน้ำเสีย โดยมีผลการดำเนินงานบรรลุตามค่าเป้าหมายที่องค์กรกำหนด
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">
                          ...
                          ดำเนินการการจัดการน้ำและน้ำเสีย อย่างมีประสิทธิภาพตามมาตรการอย่างใดอย่างหนึ่ง ดังนี้</br>

                          <div class="inline-form">
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_1" value="1">
                                  <label for="topic_3_score_1"><span class="line-height-24 d-block"></span>ประเมินค่าประสิทธิภาพการใช้น้ำ (Water use intensity) และค่าประสิทธิภาพการเกิดน้ำเสีย (Wastewater intensity) โดยมีค่าประสิทธิภาพการใช้น้ำ หรือการเกิดน้ำเสีย ดีขึ้นอย่างต่อเนื่องทุกปี อ้างอิงข้อมูล 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_2" value="2">
                                  <label for="topic_3_score_2"><span class="line-height-24 d-block"></span>นำน้ำหรือน้ำทิ้งไปใช้ภายนอกองค์กรหรือนำน้ำทิ้งจากภายนอกมาใช้ประโยชน์ภายในสถานประกอบการ (Symbiosis) ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_3" value="3">
                                  <label for="topic_3_score_3"><span class="line-height-24 d-block"></span>ไม่ปล่อยน้ำทิ้งสู่สิ่งแวดล้อมภายนอก (Zero wastewater discharge) ทั้งนี้ไม่ประยุกต์ใช้กับองค์กรที่ต้องปฏิบัติตามข้อกำหนดและกฎหมายที่เกี่ยวข้อง ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  ...
                                  <label for="topic_3_score_4"><span class="line-height-24 d-block"></span>ประเมินค่าเปรียบเทียบเชิงสมรรถนะ (Performance Benchmarking) การจัดการน้ำ โดยมีค่าเปรียบเทียบเชิงสมรรถนะสูงกว่าค่าเฉลี่ยของกลุ่มอุตสาหกรรม ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  ...
                                  <label for="topic_3_score_5"><span class="line-height-24 d-block"></span>ได้รับรางวัลด้านการจัดการน้ำและน้ำเสียระดับองค์กรที่เป็นที่ยอมรับระดับชาติ ระดับภูมิภาค หรือ ระดับสากล ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_6" value="6">
                                  <label for="topic_3_score_6"><span class="line-height-24 d-block"></span>ประเมินวอเตอร์ฟุตพรินต์ (Water footprint) อ้างอิงตามมาตรฐานสากลและนำไปบริหารจัดการเพื่อลดค่าวอเตอร์ฟุตพรินต์ ภายในระยะเวลา 3 ปี ย้อนหลั</label>
                                </div>
                            </div>
                          </div>
                ...
                <div class="col-lg-12">
                    <div class="btn-box pull-left">
                        <a href="javascript:void(0);" class="btn btn-success btn-lg" onclick="nextPage('4');"><i class="fa fa-step-forward"></i> ข้อต่อไป</a>
                    </div>
                </div>
              </div>
...
$(document).ready(function()
{
  //----------------------------------------------------------------------------
  // TOPIC 1
  var quiz3_topic_1 = localStorage.getItem("quiz3_topic_1");
  if (quiz3_topic_1 !== null)
  {
    if(quiz3_topic_1==="checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 2
  var quiz3_topic_2 = localStorage.getItem("quiz3_topic_2");
  if (quiz3_topic_2 !== null)
  {
    if(quiz3_topic_2 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE
  var quiz3_topic_2_score = localStorage.getItem("quiz3_topic_2_score");
  if (quiz3_topic_2_score !== null)
  {
    $('input:radio[name=topic_2_score][value='+quiz3_topic_2_score+']').attr('checked', true);
  }
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE TEXT
  var quiz3_topic_2_score_text = localStorage.getItem("quiz3_topic_2_score_text");
  if (quiz3_topic_2_score_text !== null)
  {
    $('#topic_2_score_text').val(quiz3_topic_2_score_text);
  }
  //----------------------------------------------------------------------------
  // TOPIC 3
  var quiz3_topic_3 = localStorage.getItem("quiz3_topic_3");
  if (quiz3_topic_3 !== null)
  {
    if(quiz3_topic_3 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 1
  var quiz3_topic_3_score_1 = localStorage.getItem("quiz3_topic_3_score_1");
  if (quiz3_topic_3_score_1 !== null)
  {
    if(quiz3_topic_3_score_1 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 2
  var quiz3_topic_3_score_2 = localStorage.getItem("quiz3_topic_3_score_2");
  if (quiz3_topic_3_score_2 !== null)
  {
    if(quiz3_topic_3_score_2 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 3
  var quiz3_topic_3_score_3 = localStorage.getItem("quiz3_topic_3_score_3");
  if (quiz3_topic_3_score_3 !== null)
  {
    if(quiz3_topic_3_score_3 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 4
  var quiz3_topic_3_score_4 = localStorage.getItem("quiz3_topic_3_score_4");
  if (quiz3_topic_3_score_4 !== null)
  {
    if(quiz3_topic_3_score_4 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 5
  var quiz3_topic_3_score_5 = localStorage.getItem("quiz3_topic_3_score_5");
  if (quiz3_topic_3_score_5 !== null)
  {
    if(quiz3_topic_3_score_5 === "checked")
    {
  ...
  // TOPIC 3 - 6
  var quiz3_topic_3_score_6 = localStorage.getItem("quiz3_topic_3_score_6");
  if (quiz3_topic_3_score_6 !== null)
  {
    if(quiz3_topic_3_score_6 === "checked")
    {
      $('#topic_3_score_6').attr("checked",true);
    }
    else
    {
      $('#topic_3_score_6').attr("checked",false);
    }
  }
  //----------------------------------------------------------------------------
...
function recapStepCheck(ids)
{
  ...
  if(count>=recapGroups_count)
  {
    ...
    localStorage.setItem("quiz3_topic_" + ids, "checked");
    localStorage.setItem("quiz3_topic_" + ids + "_score", radioanswer);
  }
  else
  {
    $("#topic_" + ids).attr("checked", false);
    localStorage.setItem("quiz3_topic_" + ids, "unchecked");
    localStorage.setItem("quiz3_topic_" + ids + "_score", "0");
  }
  return radioanswer;
}
...
window.onbeforeunload = function()
{
  ...
  {
    localStorage.setItem("quiz3_topic_1", "checked");
  }
  else
  {
    localStorage.setItem("quiz3_topic_1", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE
  localStorage.setItem("quiz3_topic_2_score_text", $('#topic_2_score_text').val());

  //----------------------------------------------------------------------------
  // TOPIC 3 - 1
  if($('#topic_3_score_1').is(':checked'))
  {
    localStorage.setItem("quiz3_topic_3_score_1", "checked");
  }
  else
  {
    localStorage.setItem("quiz3_topic_3_score_1", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 2
  if($('#topic_3_score_2').is(':checked'))
  {
    localStorage.setItem("quiz3_topic_3_score_2", "checked");
  }
  else
  {
    localStorage.setItem("quiz3_topic_3_score_2", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 3
  if($('#topic_3_score_3').is(':checked'))
  {
    localStorage.setItem("quiz3_topic_3_score_3", "checked");
  }
  else
  {
    localStorage.setItem("quiz3_topic_3_score_3", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 4
  if($('#topic_3_score_4').is(':checked'))
  {
    localStorage.setItem("quiz3_topic_3_score_4", "checked");
  }
  else
  {
    localStorage.setItem("quiz3_topic_3_score_4", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 5
  if($('#topic_3_score_5').is(':checked'))
  {
    localStorage.setItem("quiz3_topic_3_score_5", "checked");
  }
  else
  {
    localStorage.setItem("quiz3_topic_3_score_5", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 6
  if($('#topic_3_score_6').is(':checked'))
  {
    localStorage.setItem("quiz3_topic_3_score_6", "checked");
  }
  else
  {
    localStorage.setItem("quiz3_topic_3_score_6", "unchecked");
  }
  //----------------------------------------------------------------------------
}

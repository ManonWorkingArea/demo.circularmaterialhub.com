              ...
              <div class="col-md-12">
                <div class="container-fluid">
                  <ul class="list-unstyled multi-steps">
                    ...
                    <li onclick="page('app/assumption/specific/5');" class="is-active">ข้อที่ 5</li>
              ...
              <div class="col-md-12">
                <table class="table table-striped table-bordered text-left">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th>5. การจัดการก๊าซเรือนกระจก (5 คะแนน) </br><span class="description">ผู้ประกอบอุตสาหกรรมต้องดำเนินการการจัดการก๊าซเรือนกระจกอย่างมีประสิทธิภาพตามข้อกำหนดดังนี้</span><span class="pull-right score-result">ผลลัพธ์ 0 คะแนน</span></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">จัดทำบัญชีรายการก๊าซเรือนกระจกและประเมินปริมาณการปล่อยก๊าซเรือนกระจกจากกิจกรรมขององค์กรทั้งทางตรงและทางอ้อม ตามวิธีการของแนวทางการประเมินคาร์บอนฟุตพริ้นท์ขององค์การบริหารก๊าซเรือนกระจก (องค์การมหาชน) หรือมาตรฐานอื่นๆ ที่เทียบเท่า</div>
                      </td>
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">กำหนดวัตถุประสงค์ ระบุเป้าหมายขององค์กร จัดทำแผนการดำเนินงาน และ ดำเนินมาตรการเพิ่มประสิทธิภาพการจัดการก๊าซเรือนกระจก โดยมีผลการดำเนินงานบรรลุตามค่าเป้าหมายที่องค์กรกำหนด
                    ...
                    <tr class="top-form-head">
                      ...
                      <td>
                        <div class="text">
                          ...
                          มีการดำเนินกิจกรรมอย่างใดอย่างหนึ่ง </br>

                          <div class="inline-form">
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_1">
                                  <label for="topic_3_score_1"><span class="line-height-24 d-block"></span>ประเมินค่าประสิทธิภาพการปล่อยก๊าซเรือนกระจก (GHG intensity) โดยมีค่าประสิทธิภาพดีขึ้นอย่างต่อเนื่องทุกปี อ้างอิงข้อมูล 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_2">
                                  <label for="topic_3_score_2"><span class="line-height-24 d-block"></span>ประเมินค่าเปรียบเทียบเชิงสมรรถนะ (Performance benchmarking)การจัดการก๊าซเรือนกระจกโดยมีค่าเปรียบเทียบเชิงสมรรถนะสูงกว่าค่าเฉลี่ยของกลุ่มอุตสาหกรรมภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  <input type="checkbox" name="topic_3_score" id="topic_3_score_3">
                                  <label for="topic_3_score_3"><span class="line-height-24 d-block"></span>ได้รับการรับรองคาร์บอนฟุตพริ้นท์ขององค์กร ตามแนวทางการประเมินคาร์บอนฟุตพริ้นท์องค์กร (องค์การบริหารจัดการก๊าซเรือนกระจก (องค์การมหาชน)) หรือ ISO14064-1 Greenhouse gases ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-checkbox">
                                  ...
                                  <label for="topic_3_score_4"><span class="line-height-24 d-block"></span>ได้รับการรับรองการเข้าร่วมกิจกรรมชดเชยคาร์บอนองค์กรแบบบางส่วน (Carbon offsetting) หรือชดเชยคาร์บอนองค์กรแบบทั้งหมด (Carbon neutral) ภายในระยะเวลา 3 ปี ย้อนหลัง</label>
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="btn-box  pull-left">
                        <a href="javascript:void(0);" class="btn btn-success btn-lg" onclick="nextPage('6');"><i class="fa fa-step-forward"></i> ข้อต่อไป</a>
                    </div>
                </div>
              </div>
            </div>
...
$(document).ready(function()
{
  //----------------------------------------------------------------------------
  // TOPIC 1
  var quiz5_topic_1 = localStorage.getItem("quiz5_topic_1");
  if (quiz5_topic_1 !== null)
  {
    if(quiz5_topic_1==="checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 2
  var quiz5_topic_2 = localStorage.getItem("quiz5_topic_2");
  if (quiz5_topic_2 !== null)
  {
    if(quiz5_topic_2 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE
  var quiz5_topic_2_score = localStorage.getItem("quiz5_topic_2_score");
  if (quiz5_topic_2_score !== null)
  {
    $('input:radio[name=topic_2_score][value='+quiz5_topic_2_score+']').attr('checked', true);
  }
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE TEXT
  var quiz5_topic_2_score_text = localStorage.getItem("quiz5_topic_2_score_text");
  if (quiz5_topic_2_score_text !== null)
  {
    $('#topic_2_score_text').val(quiz5_topic_2_score_text);
  }
  //----------------------------------------------------------------------------
  // TOPIC 3
  var quiz5_topic_3 = localStorage.getItem("quiz5_topic_3");
  if (quiz5_topic_3 !== null)
  {
    if(quiz5_topic_3 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 1
  var quiz5_topic_3_score_1 = localStorage.getItem("quiz5_topic_3_score_1");
  if (quiz5_topic_3_score_1 !== null)
  {
    if(quiz5_topic_3_score_1 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 2
  var quiz5_topic_3_score_2 = localStorage.getItem("quiz5_topic_3_score_2");
  if (quiz5_topic_3_score_2 !== null)
  {
    if(quiz5_topic_3_score_2 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 3
  var quiz5_topic_3_score_3 = localStorage.getItem("quiz5_topic_3_score_3");
  if (quiz5_topic_3_score_3 !== null)
  {
    if(quiz5_topic_3_score_3 === "checked")
    {
  ...
  //----------------------------------------------------------------------------
  // TOPIC 3 - 4
  var quiz5_topic_3_score_4 = localStorage.getItem("quiz5_topic_3_score_4");
  if (quiz5_topic_3_score_4 !== null)
  {
    if(quiz5_topic_3_score_4 === "checked")
    {
...
function recapStepCheck(ids)
{
  ...
  if(count>=recapGroups_count)
  {
    ...
    localStorage.setItem("quiz5_topic_" + ids, "checked");
    localStorage.setItem("quiz5_topic_" + ids + "_score", radioanswer);
  }
  else
  {
    $("#topic_" + ids).attr("checked", false);
    localStorage.setItem("quiz5_topic_" + ids, "unchecked");
    localStorage.setItem("quiz5_topic_" + ids + "_score", "0");
  }
  return radioanswer;
}
...
window.onbeforeunload = function()
{
  ...
  {
    localStorage.setItem("quiz5_topic_1", "checked");
  }
  else
  {
    localStorage.setItem("quiz5_topic_1", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 2 SCORE
  localStorage.setItem("quiz5_topic_2_score_text", $('#topic_2_score_text').val());

  //----------------------------------------------------------------------------
  // TOPIC 3 - 1
  if($('#topic_3_score_1').is(':checked'))
  {
    localStorage.setItem("quiz5_topic_3_score_1", "checked");
  }
  else
  {
    localStorage.setItem("quiz5_topic_3_score_1", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 2
  if($('#topic_3_score_2').is(':checked'))
  {
    localStorage.setItem("quiz5_topic_3_score_2", "checked");
  }
  else
  {
    localStorage.setItem("quiz5_topic_3_score_2", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 3
  if($('#topic_3_score_3').is(':checked'))
  {
    localStorage.setItem("quiz5_topic_3_score_3", "checked");
  }
  else
  {
    localStorage.setItem("quiz5_topic_3_score_3", "unchecked");
  }
  //----------------------------------------------------------------------------
  // TOPIC 3 - 4
  if($('#topic_3_score_4').is(':checked'))
  {
    localStorage.setItem("quiz5_topic_3_score_4", "checked");
  }
  else
  {
    localStorage.setItem("quiz5_topic_3_score_4", "unchecked");
  }
  //----------------------------------------------------------------------------
}

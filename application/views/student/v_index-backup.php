    ...
    <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
            ...
            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                <h3 class="mb-2"><i class="material-icons">recent_actors</i> ข้อมูลผู้เรียน</h3>

                <ol class="breadcrumb p-0 m-0">
                    <li class="breadcrumb-item"><a href="home">หน้าหลัก</a></li>
                    <li class="breadcrumb-item active">ผู้เรียน</li>
                </ol>
        ...
        <div class="row" role="tablist">
            <div class="col-auto">
                <a href="student/course" class="btn btn-primary btn-icons"><i class="material-icons text-white icon--left">local_library</i> หลักสูตรของฉัน</a>
            </div>
        </div>
...
<div class="container page__container">
    <div class="page-section">
        ...
        <div class="page-separator">
            <div class="page-separator__text">สรุปข้อมูล</div>
        </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div class="flex">
                            <p class="card-title">หลักสูตร 7 Wastes</p>
                            <p class="card-subtitle text-50">คะแนนสูงสุด</p>
                        </div>
                        <div class="dropdown">
            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center border-0">
                        ...
                        <div class="flex">
                            <p class="card-title">แต้มการเรียนรู้</p>
                            <p class="card-subtitle text-50">ที่ได้รับภายในสัปดาห์นี้</p>
                        </div>
                                ...
                                <span class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
                                    <span class="row flex-nowrap">
                                        <span class="col-auto text-center d-flex flex-column justify-content-center align-items-center">
                                            ...
                                            <span class="text-white-60 d-block mb-24pt">5 ก.ค. 2563</span>
                                        </span>
                                    ...
                                    <span class="row flex-nowrap">
                                        ...
                                        <span class="col d-flex flex-column">
                                            <span>
                                                <span class="card-title text-white mb-4pt d-block">หลักสูตร 7 Wastes</span>
                                                <span class="text-white-60">หนึ่งในตัวแปรสำคัญที่จะช่วยควบคุมหรือลดต้นทุนอย่างได้ผลดีที่สุด ก็คือ การควบคุมการสูญเสีย 7 ประการ</span>
                                            </span>
                                        </span>
                                    </span>
                                </span>
...
<span class="sr-only">Previous</span>
        ...
        <div class="row mb-lg-16pt">
            <div class="col-lg-6 mb-8pt mb-sm-0">
                            ...
                            <div class="flex">
                                <div class="d-flex align-items-center">
                                    <div class="rounded mr-12pt z-0 o-hidden">
                                        <div class="overlay">
                                            <img src="theme/luma/assets/images/paths/devops_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                                    ...
                                    <div class="flex">
                                        <div class="card-title">มาตรฐานการผลิตเครื่องสำอางค์</div>
                                        <p class="flex text-black-50 lh-1 mb-0"><small>Kovic Kate Academy</small></p>
                                    </div>
                                </div>
                            </div>

                            <a href="compact-student-path.html" class="ml-4pt btn btn-sm btn-link text-secondary">เรียนต่อ</a>
                ...
                <div class="popoverContainer d-none">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="card-title">การอบรมพนักงานใหม่</div>
                            <p class="text-black-50 d-flex lh-1 mb-0 small">สถาบันทรัพยากรบุคคล</p>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex">
                                        <div class="card-title">การอบรมพนักงานใหม่</div>
                                        <p class="flex text-black-50 lh-1 mb-0"><small>สถาบันทรัพยากรบุคคล</small></p>
                                    </div>
                                </div>
                            </div>

                            <a href="compact-student-path.html" class="ml-4pt btn btn-sm btn-link text-secondary border-1 border-secondary">เรียนต่อ</a>
                ...
                <div class="popoverContainer d-none">
                    <div class="media">
                        <div class="media-left mr-12pt">
                            <img src="theme/luma/assets/images/paths/swift_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                        </div>
                        <div class="media-body">
                ...
                <div class="card js-overlay card-sm overlay--primary-dodger-blue stack stack--1 mb-16pt" data-toggle="popover" data-trigger="click">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="compact-student-path.html" class="ml-4pt btn btn-sm btn-link text-secondary">Resume</a>
                ...
                <div class="popoverContainer d-none">
                    <div class="media">
                        <div class="media-left mr-12pt">
                            <img src="theme/luma/assets/images/paths/react_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                        </div>
                        <div class="media-body">
                            <div class="card-title">React Native</div>
                            <p class="text-black-50 d-flex lh-1 mb-0 small">18 courses</p>
            ...
            <div class="col-lg-6">
                ...
                <div class="page-separator">
                    <div class="page-separator__text">หลักสูตร</div>
                </div>
                        ...
                        <div class="mdk-carousel__content">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                                    ...
                                    <a href="compact-student-take-course.html" class="js-image" data-position="">
                                        <img src="theme/luma/assets/images/paths/devops_430x168.png" alt="course">
                                    ...
                                    <span class="corner-ribbon corner-ribbon--default-right-top corner-ribbon--shadow bg-accent text-white">ใหม่</span>

                                    <div class="mdk-reveal__content">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex">
                                                    <a class="card-title" href="compact-student-take-course.html">หลักสูตร 7 Wastes</a>
                                                    <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                </div>
                                                <a href="compact-student-take-course.html" data-toggle="tooltip" data-title="Add Favorite" data-placement="top" data-boundary="window" class="ml-4pt material-icons text-20 card-course__icon-favorite">favorite_border</a>
                                            </div>
                                            <div class="d-flex">
                                ...
                                <div class="popoverContainer d-none">
                                    ...
                                    <div class="my-32pt">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <a href="compact-student-take-lesson.html" class="btn btn-primary mr-8pt">Resume</a>
                                            <a href="compact-student-take-course.html" class="btn btn-outline-secondary ml-0">Start over</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                                    ...
                                    <div class="mdk-reveal__content">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex">
                                                    <a class="card-title" href="compact-student-take-course.html">หลักสูตรการผลิตแบบ Lean</a>
                                                    <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                </div>
                                                <a href="compact-student-take-course.html" data-toggle="tooltip" data-title="Remove Favorite" data-placement="top" data-boundary="window" class="ml-4pt material-icons text-20 card-course__icon-favorite">favorite</a>
                                            </div>
                                            <div class="d-flex">
                                                <div class="rating flex">
                                                  <span class="rating__item"><span class="material-icons">sentiment_very_dissatisfied</span></span>
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="card-title mb-0">หลักสูตรการผลิตแบบ Lean</div>
                                            <p class="lh-1 mb-0">
                                                <span class="text-black-50 small">with</span>
                                                <span class="text-black-50 small font-weight-bold">Elijah Murray</span>
                                            </p>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                                    ...
                                    <a href="compact-student-take-course.html" class="js-image" data-position="">
                                        <img src="theme/luma/assets/images/paths/wordpress_430x168.png" alt="course">
                                        <span class="overlay__content align-items-start justify-content-start">
                                            <span class="overlay__action card-body d-flex align-items-center">
                                                <i class="material-icons mr-4pt">play_circle_outline</i>
                                                <span class="card-title text-white">Resume</span>
                                    ...
                                    <div class="mdk-reveal__content">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex">
                                                    <a class="card-title" href="compact-student-take-course.html">Build a WordPress Website</a>
                                                    <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                </div>
                                                <a href="compact-student-take-course.html" data-toggle="tooltip" data-title="Add Favorite" data-placement="top" data-boundary="window" class="ml-4pt material-icons text-20 card-course__icon-favorite">favorite_border</a>
                                            </div>
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="theme/luma/assets/images/paths/wordpress_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                                        </div>
                                        <div class="media-body">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                                    ...
                                    <a href="compact-student-take-course.html" class="js-image" data-position="left">
                                        <img src="theme/luma/assets/images/paths/react_430x168.png" alt="course">
                                        <span class="overlay__content align-items-start justify-content-start">
                                            <span class="overlay__action card-body d-flex align-items-center">
                                                <i class="material-icons mr-4pt">play_circle_outline</i>
                                                <span class="card-title text-white">Resume</span>
                                    ...
                                    <div class="mdk-reveal__content">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex">
                                                    <a class="card-title" href="compact-student-take-course.html">Become a React Native Developer</a>
                                                    <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                </div>
                                                <a href="compact-student-take-course.html" data-toggle="tooltip" data-title="Add Favorite" data-placement="top" data-boundary="window" class="ml-4pt material-icons text-20 card-course__icon-favorite">favorite_border</a>
                                            </div>
        ...
        <div class="page-separator">
            <div class="page-separator__text">พูดคุย/สอบถาม</div>
        </div>
...
<span aria-hidden="true" class="material-icons">chevron_right</span>
        ...
        <div class="page-separator">
            <div class="page-separator__text">แบบฝึกหัด</div>
        </div>
        ...
        <div class="row card-group-row">
            ...
            <div class="card-group-row__col col-md-6">
                ...
                <div class="card card-group-row__card card-sm">
                    <div class="card-body d-flex align-items-center">
                        <a href="student/contest/question-name" class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                            <img src="theme/luma/assets/images/paths/typescript_200x168.png" alt="Introduction to TypeScript" class="avatar-img rounded">
                            <span class="overlay__content"></span>
                        </a>
                        <div class="flex mr-12pt">
                            <a class="card-title" href="student/contest/question-name">Introduction to TypeScript</a>
                    ...
                    <div class="card-footer">
                        <div class="d-flex align-items-center">
                            <div class="flex mr-2">
                                <a href="student/contest/question-name" class="btn btn-light btn-sm">

                                    <i class="material-icons icon--left">refresh</i> ทำต่อ
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="student-take-quiz.html" class="dropdown-item text-danger">เริ่มทำใหม่</a>
                                </div>
                            </div>
            ...
            <div class="card-group-row__col col-md-6">
                ...
                <div class="card card-group-row__card card-sm">
                    <div class="card-body d-flex align-items-center">
                        <a href="student/contest/question-name" class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                            <img src="theme/luma/assets/images/paths/angular_200x168.png" alt="Angular Fundamentals" class="avatar-img rounded">
                            <span class="overlay__content"></span>
                        </a>
                        <div class="flex mr-12pt">
                            <a class="card-title" href="student/contest/question-name">Angular Fundamentals</a>
                            <div class="card-subtitle text-50">3 days ago</div>
                        </div>
                        <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex mr-2">
                                <a href="student/contest/question-name" class="btn btn-light btn-sm">
                                    ...
                                    <i class="material-icons icon--left">playlist_add_check</i> เริ่มทำใหม่

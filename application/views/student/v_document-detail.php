...
<div class="container page__container">
    <div class="row">
        <div class="col-lg-7">
          ...
          <div class="row card-group-row mt-32pt mb-lg-8pt">
                      ...
                      <div class='card-body d-flex flex-column'>
                          <div class='d-flex align-items-center '>
                              <div class='flex'>
                                  <div class='d-flex align-items-center'>
                                      <div class='flex'>
                                          <div class='card-title'>{$Document['document_name']}</div>
                          ...
                          <div class='d-flex align-items-center justify-content-center'>
                              <a href='https://{$data["Lesson"]['school_s3_bucket']}.{$data["Lesson"]['school_s3_url']}/{$Document['document_link']}' class='btn btn-primary'><i class='fa fa-download pr-1'></i> ดาวน์โหลด</a>
                          </div>
                      </div>
                  </div>
              </div>";
        ...
        <div class="col-lg-5 page-nav">
            <div class="page-section">
                ...
                <nav class="nav page-nav__menu">
                    ...
                    <a class="nav-link active" href="student/document/<?php echo $data["Lesson"]['lesson_code'];?>">เอกสารประกอบการเรียน</a>
                </nav>
            </div>
        </div>
    </div>

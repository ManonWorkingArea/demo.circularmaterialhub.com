    ...
    <div class="container page__container flex-column flex-sm-row">
            ...
            <div class="nav-item py-16pt py-sm-0">
                <div class="media flex-nowrap">
                    ...
                    <div class="media-body d-flex flex-column">
                        <a href="compact-student-take-course.html" class="card-title">Angular Fundamentals</a>
                        <div class="d-flex">
        ...
        <ul class="nav navbar-nav ml-sm-auto align-items-center align-items-sm-end d-none d-lg-flex">
            <li class="nav-item active ml-sm-16pt">
                <a href="" class="nav-link">บทเรียน</a>
            </li>
            <li class="nav-item">
                <a href="" class="nav-link">เอกสารประกอบการเรียน</a>
            </li>
            <li class="nav-item">
                <a href="" class="nav-link">บันทึกข้อความ</a>
            </li>
            <li class="nav-item">
                <a href="" class="nav-link">พูดคุย</a>
            </li>
        </ul>
    </div>
</div>
<div class="bg-primary pb-lg-64pt py-32pt">
    <div class="container page__container">
        <nav class="course-nav">
            ...
            <a data-toggle="tooltip" data-placement="bottom" data-title="Quiz: Getting Started with Angular" href="compact-student-take-quiz.html"><span class="material-icons">hourglass_empty</span></a>
        </nav>
        <div class="js-player bg-primary embed-responsive embed-responsive-16by9 mb-32pt">
            <div class="player embed-responsive-item">
                <div class="player__content">
                    <div class="player__image" style="--player-image: url(theme/luma/assets/images/illustration/player.svg)"></div>
        ...
        <a href="" class="btn btn-white">ย้อนกลับหลักสูตร</a>
    </div>
</div>
            ...
            <li class="nav-item navbar-list__item">
                <div class="media align-items-center">
                    <span class="media-left mr-16pt">
                        <img src="theme/luma/assets/images/people/50/guy-6.jpg" width="40" alt="avatar" class="rounded-circle">
                    </span>
                    <div class="media-body">
                        <a class="card-title m-0" href="compact-teacher-profile.html">Eddie Bryan</a>
...
<div class="page-section">
    <div class="container page__container">
        ...
        <div class="d-flex align-items-center mb-heading">
            <h4 class="m-0">พูดคุย</h4>
            <a href="compact-discussions-ask.html" class="text-underline ml-auto">ถามคำถาม</a>
        </div>
                ...
                <div class="list-group-item p-3">
                    <div class="row align-items-start">
                        <div class="col-md-3 mb-8pt mb-md-0">
                            <div class="media align-items-center">
                                ...
                                <div class="d-flex flex-column media-body media-middle">
                                    ...
                                    <small class="text-muted">2 วันที่ผ่านมา</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-auto d-flex flex-column align-items-center justify-content-center">
                            <h5 class="m-0">1</h5>
                            <p class="lh-1 mb-0"><small class="text-70">คำตอบ</small></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-3 mb-8pt mb-md-0">
                            <div class="media align-items-center">
                                ...
                                <div class="d-flex flex-column media-body media-middle">
                                    ...
                                    <small class="text-muted">3 วันที่ผ่านมา</small>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-8pt mb-md-0">
        ...
        <a href="compact-discussions.html" class="btn btn-outline-secondary">ดูการพูดคุยของหลักสูตรนี้ทั้งหมด</a>

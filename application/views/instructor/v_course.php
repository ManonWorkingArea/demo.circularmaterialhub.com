    ...
    <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
          ...
          <div class="mb-24pt mb-sm-0 mr-sm-24pt">
              <h3 class="mb-0"><i class="material-icons">import_contacts</i> จัดการหลักสูตร</h3>
        ...
        <div class="row" role="tablist">
            <div class="col-auto">
                <a href="instructor/course/add" class="btn btn-primary btn-icons"><i class="material-icons text-white icon--left">add_circle</i> เพิ่มหลักสูตรใหม่</a>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-overlay-onload-show data-popover-onload-show data-force-reveal data-partial-height="44" data-toggle="popover" data-trigger="click">
                <a href="compact-instructor-edit-course.html" class="js-image" data-position="">
                    <img src="theme/luma/assets/images/paths/angular_430x168.png" alt="course">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Learn Angular fundamentals</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">
            ...
            <div class="popoverContainer d-none">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <a href="compact-instructor-edit-course.html" class="btn btn-primary">Edit course</a>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                <a href="compact-instructor-edit-course.html" class="js-image" data-position="">
                    <img src="theme/luma/assets/images/paths/swift_430x168.png" alt="course">
                    <span class="overlay__content align-items-start justify-content-start">
                        <span class="overlay__action card-body d-flex align-items-center">
                            <i class="material-icons mr-4pt">edit</i>
                            <span class="card-title text-white">Edit</span>
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Build an iOS Application in Swift</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Build a WordPress Website</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                <a href="compact-instructor-edit-course.html" class="js-image" data-position="left">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Become a React Native Developer</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Learn Sketch</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Learn Flinto</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Learn Photoshop</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">
            ...
            <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal " data-partial-height="44" data-toggle="popover" data-trigger="click">
                ...
                <div class="mdk-reveal__content">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex">
                                <a class="card-title mb-4pt" href="compact-instructor-edit-course.html">Newsletter Design</a>
                            </div>
                            <a href="compact-instructor-edit-course.html" class="ml-4pt material-icons text-black-20 card-course__icon-favorite">edit</a>
                        </div>
                        <div class="d-flex">

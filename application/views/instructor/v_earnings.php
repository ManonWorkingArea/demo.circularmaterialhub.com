...
<div class="container page__container page-section">
    <div class="page-separator">
        <div class="page-separator__text">ภาพรวม</div>
    </div>
    ...
    <div class="card mb-lg-32pt">
        ...
        <div class="card-body">
            ...
            <div class="chart">
                <canvas id="ordersChart" class="chart-canvas js-update-chart-bar" data-chart-legend="#ordersChartLegend" data-chart-prefix="$" data-chart-suffix="k" data-chart-line-background-color="gradient:primary"></canvas>
            </div>
        </div>
    </div>

    <div class="page-separator">
        <div class="page-separator__text">รายการสั่งซื้อ</div>
    </div>
                ...
                <tbody class="list">
                    ...
                    <tr>
                        <td>
                            <div class="media flex-nowrap align-items-center">
                                <a href="compact-instructor-edit-course.html" class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                    <img src="theme/luma/assets/images/paths/angular_routing_200x168.png" alt="course" class="avatar-img rounded">
                                    <span class="overlay__content"></span>
                                </a>
                                <div class="media-body">
                                    <a class="text-body js-lists-values-course" href="compact-instructor-edit-course.html"><strong>Angular Routing In-Depth</strong></a>
                    ...
                    <tr>
                        <td>
                            <div class="media flex-nowrap align-items-center">
                                <a href="compact-instructor-edit-course.html" class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                    <img src="theme/luma/assets/images/paths/angular_testing_200x168.png" alt="course" class="avatar-img rounded">
                                    <span class="overlay__content"></span>
                                </a>
                                <div class="media-body">
                                    <a class="text-body js-lists-values-course" href="compact-instructor-edit-course.html"><strong>Angular Unit Testing</strong></a>
                    ...
                    <tr>
                        <td>
                            <div class="media flex-nowrap align-items-center">
                                <a href="compact-instructor-edit-course.html" class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                    <img src="theme/luma/assets/images/paths/typescript_200x168.png" alt="course" class="avatar-img rounded">
                                    <span class="overlay__content"></span>
                                </a>
                                <div class="media-body">
                                    <a class="text-body js-lists-values-course" href="compact-instructor-edit-course.html"><strong>Introduction to TypeScript</strong></a>
                    ...
                    <tr>
                        <td>
                            <div class="media flex-nowrap align-items-center">
                                <a href="compact-instructor-edit-course.html" class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                    <img src="theme/luma/assets/images/paths/angular_200x168.png" alt="course" class="avatar-img rounded">
                                    <span class="overlay__content"></span>
                                </a>
                                <div class="media-body">
                                    <a class="text-body js-lists-values-course" href="compact-instructor-edit-course.html"><strong>Learn Angular Fundamentals</strong></a>

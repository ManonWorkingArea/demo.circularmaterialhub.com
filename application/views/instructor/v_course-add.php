        ...
        <div class="flex d-flex flex-column flex-sm-row align-items-center">
          ...
          <div class="mb-24pt mb-sm-0 mr-sm-24pt">
              ...
              <ol class="breadcrumb p-0 m-0">
                  ...
                  <li class="breadcrumb-item"><a href="instructor/course">หลักสูตร</a></li>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="page-separator">
                    <div class="page-separator__text">ข้อมูลพื้นฐาน</div>
                </div>
                ...
                <div class="page-separator">
                    <div class="page-separator__text">บทเรียน</div>
                </div>
                ...
                <div class="accordion js-accordion accordion--boxed mb-24pt" id="parent">
                    <div class="accordion__item">
                        ...
                        <div class="accordion__menu collapse" id="course-toc-1">
                            <div class="accordion__menu-link">
                                ...
                                <a class="flex" href="compact-student-lesson.html">Watch Trailer</a>
                    ...
                    <div class="accordion__item open">
                        ...
                        <div class="accordion__menu collapse show" id="course-toc-2">
                            <div class="accordion__menu-link">
                                <i class="material-icons text-70 icon-16pt icon--left">drag_handle</i>
                                <a class="flex" href="compact-student-lesson.html">Introduction</a>
                                <span class="text-muted">8m 42s</span>
                            </div>
                            <div class="accordion__menu-link active">
                                <i class="material-icons text-70 icon-16pt icon--left">drag_handle</i>
                                <a class="flex" href="compact-student-lesson.html">Introduction to TypeScript</a>
                                <span class="text-muted">50m 13s</span>
                            </div>
                            <div class="accordion__menu-link">
                                <i class="material-icons text-70 icon-16pt icon--left">drag_handle</i>
                                <a class="flex" href="compact-student-lesson.html">Comparing Angular to AngularJS</a>
                                <span class="text-muted">12m 10s</span>
                            </div>
                            <div class="accordion__menu-link">
                                <i class="material-icons text-70 icon-16pt icon--left">drag_handle</i>
                                <a class="flex" href="compact-student-take-quiz.html">Quiz: Getting Started With Angular</a>
                            </div>
                        </div>
                    </div>
                    <div class="accordion__item">
                        ...
                        <div class="accordion__menu collapse" id="course-toc-3">
                            <div class="accordion__menu-link">
                                <i class="material-icons text-70 icon-16pt icon--left">drag_handle</i>
                                <a class="flex" href="compact-student-lesson.html">Angular Components</a>
                    ...
                    <div class="accordion__item">
                        ...
                        <div class="accordion__menu collapse" id="course-toc-4">
                            <div class="accordion__menu-link">
                                <i class="material-icons text-70 icon-16pt icon--left">drag_handle</i>
                                <a class="flex" href="compact-student-lesson.html">Template Syntax</a>
                                <span class="text-muted">04:23</span>
                            </div>
                        </div>
                    </div>
                ...
                <a href="#" class="btn btn-outline-secondary mb-24pt mb-sm-0">เพิ่มบทเรียน</a>
            ...
            <div class="col-md-4">
                ...
                <div class="page-separator">
                    <div class="page-separator__text">เนื้อหา</div>
                </div>
                ...
                <div class="page-separator">
                    <div class="page-separator__text">ตัวเลือก</div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">เลือกหมวดหมู่.</small>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group mb-0">
                            <label class="form-label" for="select03">ป้ายกำกับ</label>
                            ...
                            <small class="form-text text-muted">เลือกอย่างน้อย 1 ป้าย.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <img src="theme/luma/assets/images/qrcode-2.png" class="img-fluid" alt="logo">
                        </div>
                    </div>
                </div>

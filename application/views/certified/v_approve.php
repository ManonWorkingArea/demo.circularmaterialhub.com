...
if($data["Certification"]['lesson']['lesson_code'] == "water-footprint-auditor")
{
  $cer_bg = "theme/interface/aduca/assets/images/cert/cer-consultant.jpg";
}
else if($data["Certification"]['lesson']['lesson_code'] == "water-footprint-verifier")
{
  $cer_bg = "theme/interface/aduca/assets/images/cert/cer-verifier.jpg";
}
     ...
     <div class="container">
       <page size="A4" layout="landscape" id="printarea" class="html-content">
         <div class="certified">
           ...
           <div class="footer">
             <div class="qrcode">
               <div class="code">CERTIFICATE NO.<?php echo $data["Certification"]['cert_token'];?></div>
              <div class="code">CERTIFICATE DATE.<?php echo engine::thaidate($data["Certification"]['cert_createdate']);?></div>
             </div>
           </div>
         </div>
         <div class="page_bg"><img src="<?php echo $cer_bg;?>"/></div>
       </page>
     </div>

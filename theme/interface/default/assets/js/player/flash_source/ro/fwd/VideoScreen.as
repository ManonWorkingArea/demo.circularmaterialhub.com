package ro.fwd{
	...
	public class VideoScreen extends Sprite {
		...
		private function checkUpdateTimer(e:TimerEvent):void {
			...
			this.dispatchEvent(new VideoScreenEvent(VideoScreenEvent.UPDATE_TIME, curTime, totalTime, this._ns.time));
		}
		...
		public function stop(){
			...
			this.dispatchEvent(new VideoScreenEvent(VideoScreenEvent.UPDATE_TIME, "00:00", "00:00", 0));

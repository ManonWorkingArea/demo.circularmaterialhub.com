...
(function (window){
	...
	var FWDUVPInfoWindow = function(parent, data){
		...
		this.init = function(){
			...
			self.closeButton_do = new FWDUVPSimpleSizeButton(self.embedColoseN_img.src, data.embedWindowClosePathS_str, self.embedColoseN_img.width, self.embedColoseN_img.height, data.useHEXColorsForSkin_bl,

...
var FWDUVPAdsButton = function(
		...
		self.setupMainContainers = function(){
			...
			if(this.useHEXColorsForSkin_bl){
				this.icon_do = new FWDUVPDisplayObject("div");
				this.icon_do.setWidth(self.icon_img.width);
				this.icon_do.setHeight(self.icon_img.height);
				this.icon_do_canvas = FWDUVPUtils.getCanvasWithModifiedColor(this.icon_img, this.normalButtonsColor_str).canvas;
			...
			if(this.useHEXColorsForSkin_bl){
				this.iconS_do = new FWDUVPDisplayObject("div");
				this.iconS_do.setWidth(this.icon_do.w);
				this.iconS_do.setHeight(this.icon_do.h);
				this.iconS_img.onload = function(){
					self.iconS_do_canvas = FWDUVPUtils.getCanvasWithModifiedColor(self.iconS_img, self.selectedButtonsColor_str).canvas;
			...
			if(FWDUVPUtils.isIEAndLessThen9){
				if(self.isMobile_bl){
					if(self.hasPointerEvent_bl){
						self.dumy_do.screen.addEventListener("pointerup", self.onMouseUp);
						self.dumy_do.screen.addEventListener("pointerover", self.onMouseOver);
						self.dumy_do.screen.addEventListener("pointerout", self.onMouseOut);
					}else{
				...
				if(self.isMobile_bl){
					if(self.hasPointerEvent_bl){
						self.border_do.screen.addEventListener("pointerup", self.onMouseUp);
						self.border_do.screen.addEventListener("pointerover", self.onMouseOver);
						self.border_do.screen.addEventListener("pointerout", self.onMouseOut);
					}else{
		...
		this.updateHEXColors = function(normalColor_str, selectedColor_str){
			...
			this.textNormalColor_str = normalColor_str;
			this.textSelectedColor_str = selectedColor_str;
			
			try{
				FWDUVPUtils.changeCanvasHEXColor(self.icon_img, self.icon_do_canvas, normalColor_str);
				FWDUVPUtils.changeCanvasHEXColor(self.iconS_img, self.iconS_do_canvas, selectedColor_str);
				this.text_do.getStyle().color = this.textNormalColor_str;

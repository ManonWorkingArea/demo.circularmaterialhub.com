...
(function (window){
	...
	var FWDUVPInfo = function(parent, warningIconPath){
		...
		this.init = function(){
			...
			this.img_do = new FWDUVPDisplayObject("img");

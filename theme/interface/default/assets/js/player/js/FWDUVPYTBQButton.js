...
var FWDUVPYTBQButton = function(
		...
		this.onMouseOver = function(e){
			...
			self.dispatchEvent(FWDUVPYTBQButton.MOUSE_OVER, {e:e, id:self.id});
		};
			
		this.onMouseOut = function(e){
			if(self.isDisabled_bl) return;
			self.setNormalState(true);
			self.dispatchEvent(FWDUVPYTBQButton.MOUSE_OUT, {e:e, id:self.id});
		};
		
		this.onMouseUp = function(e){
			if(self.isDisabled_bl || e.button == 2) return;
			if(e.preventDefault) e.preventDefault();
			self.dispatchEvent(FWDUVPYTBQButton.CLICK, {e:e, id:self.id});
		};

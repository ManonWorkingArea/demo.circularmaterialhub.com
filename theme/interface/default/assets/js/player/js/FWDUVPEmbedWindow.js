...
(function (window){
	...
	var FWDUVPEmbedWindow = function(data, parent){
		...
		this.useHEXColorsForSkin_bl = data.useHEXColorsForSkin_bl;
		this.normalButtonsColor_str = data.normalButtonsColor_str
		this.selectedButtonsColor_str = data.selectedButtonsColor_str;
		...
		this.init = function(){
			...
			self.closeButton_do = new FWDUVPSimpleButton(self.embedColoseN_img, data.embedWindowClosePathS_str,undefined, true, self.useHEXColorsForSkin_bl,
					self.normalButtonsColor_str,
					self.selectedButtonsColor_str);
		...
		this.updateHEXColors = function(normalColor_str, selectedColor_str){
			...
			self.embedAndLinkMainLabel_do.getStyle().color = normalColor_str;
			self.sendMainLabel_do.getStyle().color = normalColor_str;
			self.linkAndEmbedHolderBk_do.getStyle().borderColor =  normalColor_str;
			self.sendMainHolderBk_do.getStyle().borderColor =  normalColor_str;
		}

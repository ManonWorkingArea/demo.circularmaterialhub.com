...
var FWDUVPSimpleButton = function(nImg, 
		...
		this.inverseHEXColors_bl = inverseHEXColors;
			...
			if(self.allowToCreateSecondButton_bl){
				...
				if(self.useHEXColorsForSkin_bl){
					...
					self.img1.onload = function(){
						if(self.inverseHEXColors_bl){
							self.s_sdo_canvas = FWDUVPUtils.getCanvasWithModifiedColor(self.img1, self.normalButtonsColor_str).canvas;
						}else{
